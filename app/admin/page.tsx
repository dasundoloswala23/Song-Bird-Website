...
export default async function AdminDashboard() {
  ...
  return (
    <div className="p-8">
      <h1 className="font-serif font-semibold text-[28px] text-white mb-1">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {cards.map(({ label, value, href, Icon }) => (
          ...
          >
            ...
            <p className="font-serif font-semibold text-[28px] text-white leading-none mb-1">{value}</p>
