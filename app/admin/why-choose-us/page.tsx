...
export default function WhyChooseUsPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      <h1 className="font-serif font-semibold text-[28px] text-white mb-8">Why Choose Us</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-navy-card border border-gold-brushed/15 rounded-xl p-6">
          <div className="flex items-center justify-between mb-5">
            <p className="font-serif font-semibold text-[18px] text-white">Feature Cards</p>
