      ...
      <div className="relative z-10 mx-auto px-6 md:px-12 max-w-3xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 text-white text-[14px] font-sans font-semibold uppercase tracking-[0.08em] rounded-[6px] transition-all hover:-translate-y-px hover:shadow-[0_8px_28px_rgba(26,107,126,.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
