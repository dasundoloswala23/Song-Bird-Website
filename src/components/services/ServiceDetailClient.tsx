  ...
  if (notFound) {
    return (
      <div className="min-h-screen bg-navy flex flex-col items-center justify-center gap-6 px-4 text-center">
        ...
        <Link href="/services" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-sans font-semibold uppercase tracking-[0.08em] text-white rounded-[6px]" style={{ background: 'linear-gradient(95deg, #1A6B7E 0%, #3FB68A 100%)' }}>
